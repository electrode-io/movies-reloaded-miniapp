...
const Section = ({ title, header, children }) =>
  <View style={styles.section}><Text style={header ? styles.header : styles.subHeader}>{title}</Text>{children}</View>
  ...
  onNavButtonPress (buttonId) {
    switch (buttonId) {
      case 'exit':
        ...
        break
      default:
        console.warn(`Screen '${About.getRegisteredRoute()}' received unmapped button id '${buttonId}'`)
        break
    }
  }

  render () {
    const renderedContributors = contributors && contributors.map(person => (
      `${person.name}${person.email ? ` (${person.email})` : ''}`
    ))
    const Highlight = ({ children }) => <Text style={styles.highlight}>{children}</Text>
    const Code = ({ children }) => <Text style={styles.code}>{children}</Text>

    return (
      <View style={styles.container}>
        <Image source={ElectrodeLogo} style={styles.background} resizeMode='contain' />
          ...
          <View style={styles.content}>
            ...
            <Section title='Who...'>
              ...
              <SubSection>
                ...
                <Paragraph>
                  Anyone who is interested in using <Highlight>Electrode Native</Highlight>.
                </Paragraph>
              </SubSection>
            </Section>
            <Section title='Where...'>
            ...
            <Section title='What...'>
              <SubSection>
                ...
                <Paragraph>
                  <Highlight>Electrode Native Navigation</Highlight> allows an <Highlight>Electrode
                  Native</Highlight> miniapp to quickly and easily set up inter- and intra-miniapp
                  navigation for any number of miniapps. After setting up a miniapp's components with
                  the <Code>AppNavigator.RegisterAll()</Code> method, all of your screens will
              ...
              <SubSection>
                ...
                <Paragraph>
                  ...
                  our <Highlight>Electrode Native Navigation</Highlight>.
                </Paragraph>
              </SubSection>
              <SubSection>
                <Question>Is provided by <Code>Component</Code>?</Question>
                <Paragraph>
                  <Code>&lt;Component&gt;.back()</Code> allows you to go back one screen.  If on
                  the first screen of your miniapp, it will exit the miniapp.
                </Paragraph>
                <Paragraph>
                  <Code>&lt;Component&gt;.backTo()</Code> allows you to go back to any screen in
                  your backstack.
                </Paragraph>
                <Paragraph>
                  <Code>&lt;Component&gt;.finish()</Code> allows you to finish your current flow.
                </Paragraph>
                <Paragraph>
                  <Code>&lt;Component&gt;.navigate()</Code> allows you to navigate anywhere in
                  the application.
                </Paragraph>
                <Paragraph>
                  <Code>&lt;Component&gt;.navigateInternal()</Code> allows you to navigate
                  anywhere in the current miniapp.
                </Paragraph>
              </SubSection>
              <SubSection>
                <Question>Is provided by <Code>AppNavigator</Code>?</Question>
                <Paragraph>
                  <Code>&lt;AppNavigator&gt;.registerAll()</Code> registers all screens which were defined
            ...
            <Section title='Acknowledgements'>
              <SubSection>
                ...
                <Image source={TMDBLogo} style={styles.tmdb} resizeMode='contain' />
              </SubSection>
            </Section>
          </View>
        </ScrollView>
